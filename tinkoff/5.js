...
Команда Ксюши распределена на n городов, поэтому необходимо придумать маршрут их посещения. Всего существует m междугородних рейсов, которыми Ксюша может воспользоваться. i-ый рейс ведет из города ui в город vi, причем ui < vi. Все рейсы односторонние, при этом никаких других ограничений нет: между любой парой городов может существовать любое число рейсов (но все в одном направлении). Для каждого рейса известна его четность. По четному рейсу можно путешествовать только в четные дни и наоборот. Можно считать, что дни нумеруются натуральными числами до бесконечность.
Ксюша начинает поездку в городе под номером 1 и заканчивает в городе под номером n, путешествуя между городами только по разрешенным рейсам в дни с нужной четностью. Для каждого города известно, что аэропорт в нем работает либо только в четные дни, либо только в нечетные. Например, если из города u разрешены только четные рейсы в город v, а аэропорт в u работает только по нечетным дням, то попасть из u в v напрямую не получится. Для командировки Ксюша выберет кратчайший по числу перелетов маршрут.
...
Формат входных данных
	В первой строке вводятся целые числа n и m (1 ≤
	n ≤ 5 ⋅ 105 , 0 ≤ m ≤ 5 ⋅ 105 ) — количество городов и рейсов соответственно.
	В следующих m строках содержится описание рейсов. В i-ой строке записаны три целых числа ui , vi иti (1≤ui,vi ≤n,ti ∈{0,1})
	—номера городов, соединяемых i-ым рейсом, и его четность (0 — четный рейс, 1 — нечетный).
